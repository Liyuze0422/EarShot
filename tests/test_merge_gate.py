...
@pytest.mark.parametrize('t, half', [
    ...
    ('我们团队一共五个人我负责检索模块', False),
    # 实机演练（2026-09-14 真实 HR 面回放）抓到的截断：场景题前半段够长，
    # 被当成完整问题立刻发出并答掉，真正的问法来时主题已经被占了。
    ('那比如说我们先有一个项目啊，我们脚本给到你给给的之前是个 A 的版本。嗯，然后在'
     '工作过程中先按照脚本 A 去写的这个脚本，然后就做算码调度这些嘛。', True),
    ('但是你的代码已经写死了的情况下，你会怎么去解决这个问题呢？', False),
    ('那你现在这个相当于这个项目的使用范围是不是就只能在当地嘛，因为你这样不是都要'
     '手动处理过吗。', False),
    ('我的自我介绍完毕，谢谢。嗯，我想了解一下，就是您在项目中你是有。', True),
])
